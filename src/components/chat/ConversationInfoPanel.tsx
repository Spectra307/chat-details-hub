  ...
  return (
    <div className="flex h-full w-80 flex-col border-l bg-card">
      ...
      <div className="flex flex-col items-center gap-3 px-4 py-6 border-b">
        <div
          className={`relative flex h-20 w-20 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-2xl overflow-hidden ${isGroup ? "cursor-pointer" : ""}`}
          onClick={() => isGroup && setShowAvatarDialog(true)}
        >
          {displayAvatar ? (
