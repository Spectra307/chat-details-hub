    ...
    <div className="flex h-full w-72 flex-col bg-sidebar text-sidebar-foreground">
        ...
        {loading ? (
          ...
          filtered.map((conv) => {
            ...
            return (
              ...
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-sidebar-accent/20 text-sidebar-accent font-semibold text-sm">
                  {conv.is_group ? <Users className="h-4 w-4" /> : avatar}
                </div>
      ...
      <div className="border-t border-sidebar-border p-3">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-sidebar-accent text-primary-foreground font-semibold text-sm">
